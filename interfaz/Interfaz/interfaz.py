...
class MenuMascotas:
    ...
    def agregarMascota(self):
        ...
        if pet_name and pet_age and pet_weight and pet_height and pet_type and pet_breed and vaccination_status:
            pet_data = f"Nombre: {pet_name} | Edad: {pet_age} | Peso: {pet_weight} | Altura: {pet_height} | Tipo: {pet_type} | Raza: {pet_breed} | Vacunación: {vaccination_status}"
            self.pet_list.insert(tk.END, pet_data)
